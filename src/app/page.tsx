    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-800 text-white overflow-hidden">
      ...
      <section id="prizes" className="py-20">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { position: "1st Place", prize: "₹50,000", extra: "Mentorship Program" },
              { position: "2nd Place", prize: "₹30,000", extra: "Industry Connect" },
              { position: "3rd Place", prize: "₹20,000", extra: "Certificate of Excellence" }
            ].map((item, idx) => (
              <div key={idx} className={`relative p-8 rounded-2xl border-2 hover:scale-105 transition-all duration-300 ${
                idx === 0 ? 'border-yellow-400 bg-gradient-to-br from-yellow-400/10 to-transparent' : 'border-gray-600 bg-gradient-to-br from-gray-800/50 to-transparent'
              }`}>
                <div className="text-center">
      ...
      <footer className="py-12 border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-400 mb-4">Powered by Quasar Hackathon Network</p>
